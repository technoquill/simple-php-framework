    ...
    'view' => [
        ...
        'templates' => [
            'default' => [
                ...
                'assets_path' => base_path() . '/resources/templates/default/assets',
            ...
            'admin' => [
                'template_path' => base_path() . '/resources/views/admin',
                'asset_path' => base_path() . '/resources/assets/admin',
                'errors_path' => base_path() . '/resources/views/admin/errors',
                'layout' => 'admin',
                'use_layout' => true,
                'cache' => false,
            ],
